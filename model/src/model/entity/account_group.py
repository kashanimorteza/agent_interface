...
class AccountGroup(
    ...
    composite_constraints=(
        Constraint(
            id="account_group_user_id_name_unique",
    ...
    id: Annotated[
        int,
        Declare(
            description="The unique identity of the account group.",
    ...
    name: Annotated[
        str,
        Declare(description="The account group's display name.", logical_type="string"),
    ]
    is_active: Annotated[
        bool,
        Declare(
    ...
    description: Annotated[
        str | None,
        Declare(description="Describes the account group.", logical_type="string"),
    ]
