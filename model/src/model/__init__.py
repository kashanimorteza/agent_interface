"""The Model Component: the authoritative Domain Definitions of the Trading Assistant.

Every Domain Definition is published here, under its own name, and nowhere else.
"""
