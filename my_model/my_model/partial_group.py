...
class PartialGroup(BaseModel):
    ...
    determining how much of the trade volume must be closed when profit or
    loss reaches specified thresholds.
    """

    id: int = Field(description="The partial group's logical identity.")
