...
class Position(BaseModel):
    ...
    system, whether already opened or still pending execution.
    """

    id: int = Field(description="The position's logical identity.")
    ...
    profit: Decimal = Field(default=Decimal(0), description="The position's current profit or loss.")
