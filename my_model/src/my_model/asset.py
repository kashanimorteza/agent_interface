"""The Asset domain entity: an asset that can be selected for trading."""
...
class Asset(BaseModel):
    ...
    Provides the complete set of available tradable assets and identifies
    the category of each asset so the system knows exactly what is being
    traded.
    """

    UNIQUE_TOGETHER: ClassVar[tuple[tuple[str, ...], ...]] = (("broker_id", "symbol"),)
