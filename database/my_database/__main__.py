...
Creating the storage structure belongs to the migration tooling and is not a
command here.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    seed.add_argument("--instance", default=None, help="Instance key; the default when omitted")
    commands.add_parser("generate-key", help="print a new key for the reversible at-rest mode")
    ...
    database = Database()
    try:
        report = database.seed(instance=args.instance)
    finally:
        database.close()
