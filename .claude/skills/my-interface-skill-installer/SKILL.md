...
This file is the self-contained Claude Code realization of the portable `skill-installer` contract synchronized by Agent Sync. Follow this adapter and synchronized Runtime rules; never read or resolve Agent Module sources.
