...
metadata:
  ...
  synced_at: "2026-09-18T13:14:37Z"
---
...
3. Compare section by section — for a Contract, obligation by obligation, since each bullet is one obligation — and record every difference of four kinds: the artifact instructs something the declaration no longer requires; omits something it requires; states a rule the declaration has changed; or states an obligation with a different scope than the declaration gives it, however it is worded.
