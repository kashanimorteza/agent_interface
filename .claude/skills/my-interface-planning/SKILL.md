...
metadata:
  ...
  contract_sha256: "sha256:e7ee54c8c077734c260a35296f5fcef65c9369d340c2c1339ff67a942b360d60"
...
4. **Agent parameters and associated Skills** — by phase, the `agent` parameters carried into each governed Task and any recorded as overridden, and each `agent.skills` association a selected item declared, whether it resolved to a usable Runtime Skill, and where its conformance was written into acceptance.
