...
Do not fix what you found — not the code, not the plan, not a contract. Writing tasks belongs to the `planner` Skill and implementing them to the `developer` Skill. Report to the human and stop.
