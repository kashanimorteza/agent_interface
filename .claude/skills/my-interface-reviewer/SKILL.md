...
Read `.interface/map.yaml`. This is the only Interface path this Skill may assume. Follow its current map and read order to discover every source, plan, authority, configuration, interface, implementation boundary, and verification source required for this run.
