<!-- Rule: interface-bootstrap | scope: global (loaded at session start for all work) | required: true | Synchronized Claude Code realization by /my-interface-agent-native; not an authority. -->
