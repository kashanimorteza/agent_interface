<!-- Synchronized by /my-interface-agent-native from the Human-owned Agent Rule "git-discipline". Scope: global. Do not edit here; this file is a Runtime realization, never an authority. -->
