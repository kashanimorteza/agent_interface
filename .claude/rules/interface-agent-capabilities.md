...
|---|---|---|---|
| `project_skills.contextual.fastapi` | `fastapi` at `.claude/skills/fastapi/SKILL.md` | When a current Developer or Target choice selects FastAPI | No |
| `project_skills.contextual.typer` | `typer` at `.claude/skills/typer/SKILL.md` | When relevant to a current Typer selection | No |
