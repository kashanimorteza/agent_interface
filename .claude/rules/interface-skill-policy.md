<!--
Native realization (Claude Code) of the Agent Rule `interface-skill-policy`, synchronized by
...
Enforcement: the PreToolUse / UserPromptExpansion / UserPromptSubmit / Stop hooks declared in
.claude/settings.json (scripts under .claude/hooks/) realize the Permission guarantees this Rule explains.
-->
