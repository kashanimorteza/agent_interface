<!-- Rule `interface-skill-policy` · scope: global (loaded for all work) · synchronized Runtime realization of a Human-owned Rule contract; edit the source and re-run /my-interface-agent-native instead of editing this file. -->
