<!-- Synchronized Runtime Rule. Scope: global (always loaded). Source contract: .interface/agent/rule/contracts/interface-skill-policy.md, realized by Agent Native Sync (/my-interface-agent-native). The Human-owned contract is the authority; this file is its Claude Code realization. -->
