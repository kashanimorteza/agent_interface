<!-- Synchronized by /my-interface-agent-native. Scope: global (always loaded). Native realization only; the Human-owned Agent Module is the authority. Do not edit by hand; re-run /my-interface-agent-native. -->
