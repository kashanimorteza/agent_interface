...
- **Agent Native Sync** — the Foundation instruction and Agent Skill `/my-interface-agent-native` that reads the Agent Module and realizes it in the selected Agent Native.
