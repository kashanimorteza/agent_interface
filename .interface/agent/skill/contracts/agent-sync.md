...
Accept no capability selection. Consume the complete Agent Profile, including explicit empty categories, all portable Skill Contracts, optional prepared Markdown Skill files matched by declared stable key, the selected Runtime mapping, native project artifacts, and runtime-reported Activation state.
